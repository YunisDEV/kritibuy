from .business import business_data_get

businessDashboardTree = {
    "analytics": {
        "icon": """
    ...
    "inbox": {
        "icon": """
        <svg style="fill:white;" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 219 219" style="enable-background:new 0 0 219 219;" xml:space="preserve"> <path d="M195.501,49.5H114V32.07c0-7.679-5.574-13.57-13.253-13.57H14.736C7.057,18.5,0,24.391,0,32.07v41.797v14.944V176.5  c0,13.439,11.727,24,25.166,24h170.335c13.439,0,23.499-10.561,23.499-24V73.867C219,60.428,208.94,49.5,195.501,49.5z   M146.986,125.64l-33.089,40.005c-1.581,1.906-5.54,1.961-7.121,0.054l-33.094-40.086c-1.447-1.744,0.364-4.113,3.26-4.113H91  V88.325c0-2.84,3.394-4.825,7.479-4.825h23.708c4.085,0,6.813,1.985,6.813,4.825V121.5h14.725  C146.621,121.5,148.432,123.896,146.986,125.64z"/> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> <g> </g> </svg>
        """,
        "indexes": [
            {
                "name": 'Orders',
